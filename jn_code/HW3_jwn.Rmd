...
colnames(seurat.obj.f_doublets@meta.data)[ncol(seurat.obj.f_doublets@meta.data)] <- "DF.class"
colnames(seurat.obj.f_doublets@meta.data)[ncol(seurat.obj.f_doublets@meta.data) - 1] <- "pANN"
...
# what is the name of the 6th column in the metadata?
